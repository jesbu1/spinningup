...
register(
    id='MT10Helper-v0',
    entry_point='gym.envs.metaworld.MT10:MT10HelperEnv',
    max_episode_steps=150,
)
register(
    id='MT50Helper-v0',
    entry_point='gym.envs.metaworld.MT50:MT50HelperEnv',
    max_episode_steps=150,
)
register(
    id='SawyerPush-v0',
    entry_point='gym.envs.metaworld.sawyer_push:SawyerPushEnv',
    max_episode_steps=150,
)
# Algorithmic
# ----------------------------------------
