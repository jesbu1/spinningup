...
class SawyerButtonPressTopdownEnv(SawyerXYZEnv):
    def __init__(
        ...
        hand_high=(0.5, 1, 0.5)
        obj_low=(-0.1, 0.8, 0.12)
        obj_high=(0.1, 0.9, 0.12)
        ...
        self.init_config = {
            'obj_init_pos': np.array([0, 0.8, 0.12], dtype=np.float32),
    ...
    @property
    def model_name(self):
        return get_asset_full_path('assets_updated/sawyer_xyz/sawyer_button_press_topdown.xml')
