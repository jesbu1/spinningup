import numpy as np
from metaworld.envs.mujoco.sawyer_xyz.sawyer_door_updated import SawyerDoorEnv
...
class SawyerDoorCloseEnv(SawyerDoorEnv):
    def __init__(
        ...
        self.goal = np.array([0.24, 0.79, 0.15])
    ...
    def reset_model(self):
        ...
        if self.random_init:
            ...
            goal_pos = obj_pos.copy() + np.array([0.1, -0.16, 0.0])
