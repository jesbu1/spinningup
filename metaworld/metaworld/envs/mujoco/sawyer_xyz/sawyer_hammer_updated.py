...
class SawyerHammerEnv(SawyerXYZEnv):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('assets_updated/sawyer_xyz/sawyer_hammer.xml')
    ...
    def step(self, action):
        ...
        info = {'reachDist': reachDist, 'pickRew':pickRew, 'epRew' : reward, 'goalDist': screwDist, 'success': float(screwDist <= 0.05 and reachDist <= 0.08)}
    ...
    def _get_obs(self):
        ...
        hammerHeadPos = self.get_site_pos('hammerHead').copy()
    ...
    def _get_obs_dict(self):
        ...
        objPos =  self.get_body_com('nail_link')
    ...
    def reset_model(self):
        ...
        self.hammer_init_pos = self.init_config['hammer_init_pos']
        self.hammerHeight = self.get_body_com('hammerbody').copy()[2]
        ...
        self.obj_init_pos = self.sim.model.site_pos[self.model.site_name2id('nailHead')] + self.sim.model.body_pos[self.model.body_name2id('box')]
