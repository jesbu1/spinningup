...
class SawyerDoorEnv(SawyerXYZEnv):
    def __init__(
        ...
        self.goal = np.array([-0.15, 0.475, 0.15])
    ...
    @property
    def model_name(self):
        return get_asset_full_path('assets_updated/sawyer_xyz/sawyer_door_pull.xml')
    ...
    def reset_model(self):
        ...
        if self.random_init:
            ...
            goal_pos = obj_pos.copy() + np.array([-0.25, -0.475, 0.])
