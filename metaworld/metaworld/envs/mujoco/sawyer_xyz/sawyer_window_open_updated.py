...
class SawyerWindowOpenEnv(SawyerXYZEnv):
    ...
    @property
    def model_name(self):     
        return get_asset_full_path('assets_updated/sawyer_xyz/sawyer_window_horizontal.xml')
    ...
    def reset_model(self):
        ...
        self.objHeight = self.get_site_pos('handleOpenStart')[2]
        ...
        # self.sim.model.body_pos[self.model.body_name2id('windowb_b')] = window_another_pos
